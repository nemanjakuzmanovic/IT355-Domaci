...
/**
 * A backing bean for the main flight search form. Encapsulates the criteria needed to perform a flight search.
 * 
...
public class SearchCriteria implements Serializable {
    ...
    /**
     * The maximum page size of the Flight result list
     */
    private int pageSize;

    /**
     * The current page of the Flight result list.
     */
    private int page;
